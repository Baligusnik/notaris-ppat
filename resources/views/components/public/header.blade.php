<header class="site-header">
    ...
    <button class="hamburger" type="button" aria-expanded="false"><span></span><span></span><span></span><b data-i18n="nav.menu">Menu</b></button>
        <div class="nav-links">
            ...
            <a href="#pendaftaran"><img class="mobile-nav-icon" src="{{ asset('images/nav-icons/pendaftaran.svg') }}" alt=""><span data-i18n="nav.registration">Pendaftaran Berkas Baru</span></a>
