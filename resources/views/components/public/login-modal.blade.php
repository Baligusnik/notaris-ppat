<div class="login-modal" id="loginModal" aria-hidden="true">
    ...
    <div class="login-dialog" role="dialog" aria-modal="true" aria-labelledby="loginTitle">
        ...
        <form class="login-card" id="publicLoginForm">
            ...
            <label><span data-i18n="auth.username">Email / Username</span><input type="text" name="username" value="admin@notarisppat.local" autocomplete="username" required></label>
            <label><span data-i18n="auth.password">Password</span><input type="password" name="password" value="admin123" autocomplete="current-password" required></label>
